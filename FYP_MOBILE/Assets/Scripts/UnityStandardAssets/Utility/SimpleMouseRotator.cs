	...
	public class SimpleMouseRotator : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			else
			{
				...
				m_TargetAngles.y = Mathf.Lerp((0f - rotationRange.y) * 0.5f, rotationRange.y * 0.5f, x / (float)Screen.width);
				m_TargetAngles.x = Mathf.Lerp((0f - rotationRange.x) * 0.5f, rotationRange.x * 0.5f, y / (float)Screen.height);
			}
